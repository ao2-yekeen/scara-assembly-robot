...
# ─── MEASURED ZONE POSITIONS (robot base frame, metres) ──────────────────────
# Real-world (x, y) coordinates for each cell, measured physically.
# Stored row-major: index = row * ZONE_COLS + col
ZONE_COLS = 5   # number of columns in both grids
PICKUP_POSITIONS = [
    (0.0472, 0.1392), (0.0700, 0.1617), (0.0927, 0.1842),
    (0.1154, 0.2067), (0.1382, 0.2293), (0.0697, 0.1165),
    (0.0925, 0.1390), (0.1152, 0.1615), (0.1380, 0.1840),
    (0.1607, 0.2065), (0.0922, 0.0937), (0.1150, 0.1162),
    (0.1377, 0.1387), (0.1605, 0.1612), (0.1832, 0.1838),
    (0.1147, 0.0710), (0.1375, 0.0935), (0.1602, 0.1160),
    (0.1830, 0.1385), (0.2057, 0.1610), (0.1372, 0.0482),
    (0.1600, 0.0707), (0.1827, 0.0932), (0.2055, 0.1158),
    (0.2282, 0.1383),
]

PLACE_POSITIONS = [
    (0.1382, -0.2293), (0.1154, -0.2067), (0.0927, -0.1842),
    (0.0700, -0.1617), (0.0472, -0.1392), (0.1607, -0.2065),
    (0.1380, -0.1840), (0.1152, -0.1615), (0.0925, -0.1390),
    (0.0697, -0.1165), (0.1832, -0.1838), (0.1605, -0.1612),
    (0.1377, -0.1387), (0.1150, -0.1162), (0.0922, -0.0937),
    (0.2057, -0.1610), (0.1830, -0.1385), (0.1602, -0.1160),
    (0.1375, -0.0935), (0.1147, -0.0710), (0.2282, -0.1383),
    (0.2055, -0.1158), (0.1827, -0.0932), (0.1600, -0.0707),
    (0.1372, -0.0482),
]
